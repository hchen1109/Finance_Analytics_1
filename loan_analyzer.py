...
print(f"The number of loans is: {number_of_loan}")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
sum_of_loan_costs = sum(loan_costs)
# Print the total value of the loans
print(f"The sum of loan is:{sum_of_loan_costs}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average = sum_of_loan_costs/number_of_loan
...
print(f'The repayment_interval is: {repayment_interval}')
print (f'The future_value is: {future_value}')
...
print(f'The new loan price is: {loan_price}')
print(f'The new number of remaining months is: {remaining_months}')
print(f'The new repayment_interval is: {repayment_interval}')
print (f'The new future_value is: {future_value}')
